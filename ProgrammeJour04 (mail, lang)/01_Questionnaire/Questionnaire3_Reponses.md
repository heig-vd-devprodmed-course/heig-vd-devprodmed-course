...
>
> ​	Remarque : Pour voir ce jeton, il suffit de demander au navigateur d'afficher le code source de la page lorsque le formulaire est affiché.
> 
>```html
...
> L'objet est de type `Request` et on peut nommer la variable (qui y fait référence) comme on veut :wink:
> (Dans les exemples réalisés, il se nomme : `$request`)
