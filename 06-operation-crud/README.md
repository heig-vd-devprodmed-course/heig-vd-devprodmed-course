...
- Théorie : [Support de cours](./02-support-de-cours/SUPPORT_DE_COURS.md)
- Présentation : [Présentation](./01-presentation/README.md)
...
- Finaliser le support de cours si nécessaire
- Finaliser les exercices qui n'ont pas été terminés en classe
- Commencer le projet "Une fiction numérique guidée par vos choix"
