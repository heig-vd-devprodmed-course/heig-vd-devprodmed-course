...
- [Blog](#blog)
- [Relation 1:N dans les classes-modèles](#relation-1n-dans-les-classes-modèles)
- [Peuplement des tables `users` et `articles`](#peuplement-des-tables-users-et-articles)
- [Seeder](#seeder)
- [Ordre du peuplement des tables (`DatabaseSeeder`)](#ordre-du-peuplement-des-tables-databaseseeder)
- [Création des enregistrements](#création-des-enregistrements)
- [Contrôleur](#contrôleur)
- [Route](#route)
- [Template](#template)
- [Vue (Liste des articles)](#vue-liste-des-articles)
...
![liste-articles](./images/ListeArticles.png)
