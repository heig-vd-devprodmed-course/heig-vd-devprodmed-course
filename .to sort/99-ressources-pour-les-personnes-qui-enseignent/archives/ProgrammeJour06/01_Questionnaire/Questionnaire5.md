...
5.) Quelle(s) commande(s) permettent de créer / supprimer la nouvelle table dans
la base de donnée ?
...
​ Combien de tables crée la commande : `php artisan migrate` ? ​ Pourquoi y
a-t-il plus de tables qu'attendu ?
